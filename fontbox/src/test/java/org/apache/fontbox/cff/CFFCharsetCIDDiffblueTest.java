...
class CFFCharsetCIDDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CFFCharsetCID#isCIDFont()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link CFFCharsetCID#addSID(int, int, String)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link CFFCharsetCID#getSIDForGID(int)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link CFFCharsetCID#getGIDForSID(int)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Given {@link CFFCharsetCID} (default constructor) addCID one and one.
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link CFFCharsetCID#getGIDForCID(int)}
   */
  @Test
  @DisplayName(
      "Test getGIDForCID(int); given CFFCharsetCID (default constructor) addCID one and one; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link CFFCharsetCID} (default constructor).
   *   <li>Then return zero.
   * </ul>
   *
   * <p>Method under test: {@link CFFCharsetCID#getGIDForCID(int)}
  ...
  @Test
  @DisplayName(
      "Test getGIDForCID(int); given CFFCharsetCID (default constructor); then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int CFFCharsetCID.getGIDForCID(int)"})
   ...
   *
   * <p>Method under test: {@link CFFCharsetCID#getSID(String)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link CFFCharsetCID#getNameForGID(int)}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link CFFCharsetCID#getCIDForGID(int)}
   */
  @Test
  @DisplayName(
      "Test getCIDForGID(int); given CFFCharsetCID (default constructor) addCID one and one; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test getCIDForGID(int); given CFFCharsetCID (default constructor); then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int CFFCharsetCID.getCIDForGID(int)"})
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link CFFCharsetCID}
   */
  @Test
