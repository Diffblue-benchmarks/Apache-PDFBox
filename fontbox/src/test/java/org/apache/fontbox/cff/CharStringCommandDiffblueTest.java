...
class CharStringCommandDiffblueTest {
  /**
   * Test {@link CharStringCommand#getInstance(int, int)} with {@code b0}, {@code b1}.
   *
   * <ul>
   *   <li>When minus one.
   ...
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int, int)}
   */
  @Test
  @DisplayName("Test getInstance(int, int) with 'b0', 'b1'; when minus one; then return 'UNKNOWN'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int, int)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int)}
   */
  @Test
  @DisplayName("Test getInstance(int) with 'b0'; when minus one; then return 'UNKNOWN'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int)"})
   ...
   *
   * <ul>
   *   <li>When array of {@code int} with forty-two and one.
   *   <li>Then return {@code UNKNOWN}.
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int[])}
  ...
  @Test
  @DisplayName(
      "Test getInstance(int[]) with 'values'; when array of int with forty-two and one; then return 'UNKNOWN'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int[])"})
  void testGetInstanceWithValues_whenArrayOfIntWithFortyTwoAndOne_thenReturnUnknown() {
    // Arrange, Act and Assert
    assertEquals(
        CharStringCommand.UNKNOWN, CharStringCommand.getInstance(new int[] {42, 1, 42, 1}));
  }
   ...
   *
   * <ul>
   *   <li>When array of {@code int} with minus one.
   *   <li>Then return {@code UNKNOWN}.
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int[])}
  ...
  @Test
  @DisplayName(
      "Test getInstance(int[]) with 'values'; when array of int with minus one; then return 'UNKNOWN'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int[])"})
   ...
   *
   * <ul>
   *   <li>When array of {@code int} with one.
   *   <li>Then return {@code HSTEM}.
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int[])}
  ...
  @Test
  @DisplayName(
      "Test getInstance(int[]) with 'values'; when array of int with one; then return 'HSTEM'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int[])"})
   ...
   *
   * <ul>
   *   <li>When array of {@code int} with two hundred thirty.
   *   <li>Then return {@code UNKNOWN}.
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int[])}
  ...
  @Test
  @DisplayName(
      "Test getInstance(int[]) with 'values'; when array of int with two hundred thirty; then return 'UNKNOWN'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int[])"})
   ...
   *
   * <ul>
   *   <li>When array of {@code int} with zero.
   *   <li>Then return {@code UNKNOWN}.
   * </ul>
   *
   * <p>Method under test: {@link CharStringCommand#getInstance(int[])}
  ...
  @Test
  @DisplayName(
      "Test getInstance(int[]) with 'values'; when array of int with zero; then return 'UNKNOWN'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CharStringCommand CharStringCommand.getInstance(int[])"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Type1KeyWord CharStringCommand.getType1KeyWord()",
    "Type2KeyWord CharStringCommand.getType2KeyWord()",
    "int CharStringCommand.getValue()",
    "java.lang.String CharStringCommand.toString()"
  })
  void testGettersAndSetters() {
    ...
    // Act
    Type1KeyWord actualType1KeyWord = valueOfResult.getType1KeyWord();
    Type2KeyWord actualType2KeyWord = valueOfResult.getType2KeyWord();
    int actualValue = valueOfResult.getValue();

    // Assert
    assertEquals("HSTEM|", valueOfResult.toString());
    assertEquals(1, actualValue);
    assertEquals(Type1KeyWord.HSTEM, actualType1KeyWord);
    assertEquals(Type2KeyWord.HSTEM, actualType2KeyWord);
  }
}
