...
class MacFontDirFinderDiffblueTest {
   ...
   *
   * <p>Method under test: {@link MacFontDirFinder#getSearchableDirectories()}
   */
  @Test
  ...
  void testGetSearchableDirectories() {
    ...
    // Assert
    Path getResult = Paths.get(System.getProperty("user.home"), "Library", "Fonts");
    assertArrayEquals(
        new String[] {
          getResult.toString().concat(File.separator),
          "/Library/Fonts/",
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link MacFontDirFinder}
   */
  @Test
