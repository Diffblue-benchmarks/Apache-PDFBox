...
class BuiltInEncodingDiffblueTest {
   ...
   * <ul>
   *   <li>Given one.
   *   <li>When {@link HashMap#HashMap()} one is {@code Value}.
   * </ul>
   *
   * <p>Method under test: {@link BuiltInEncoding#BuiltInEncoding(Map)}
   */
  @Test
  @DisplayName("Test new BuiltInEncoding(Map); given one; when HashMap() one is 'Value'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void BuiltInEncoding.<init>(Map)"})
  void testNewBuiltInEncoding_givenOne_whenHashMapOneIsValue() {
    // Arrange
