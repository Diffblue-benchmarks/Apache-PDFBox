...
class LookupTypeSingleSubstFormat2DiffblueTest {
   ...
   *
   * <ul>
   *   <li>{@link LookupTypeSingleSubstFormat2#LookupTypeSingleSubstFormat2(int, CoverageTable,
   *       int[])}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void LookupTypeSingleSubstFormat2.<init>(int, CoverageTable, int[])",
    "int[] LookupTypeSingleSubstFormat2.getSubstituteGlyphIDs()",
    "String LookupTypeSingleSubstFormat2.toString()"
  })
  void testGettersAndSetters() {
    ...
    // Act
    LookupTypeSingleSubstFormat2 actualLookupTypeSingleSubstFormat2 =
        new LookupTypeSingleSubstFormat2(1, coverageTable, substituteGlyphIDs);
    ...
    // Assert
    assertEquals(
        "LookupTypeSingleSubstFormat2[substFormat=1,substituteGlyphIDs=[1, 2, 1, 2]]",
   ...
   * </ul>
   *
   * <p>Method under test: {@link LookupTypeSingleSubstFormat2#doSubstitution(int, int)}
   */
  @Test
  ...
  void testDoSubstitution_thenReturnTwo() {
    ...
    LookupTypeSingleSubstFormat2 lookupTypeSingleSubstFormat2 =
        new LookupTypeSingleSubstFormat2(3, coverageTable, new int[] {1, 2, 1, 2});

    // Act and Assert
    assertEquals(2, lookupTypeSingleSubstFormat2.doSubstitution(1, 1));
  }
  ...
  void testDoSubstitution_whenMinusOne_thenReturnOne() {
    ...
    // Act and Assert
    assertEquals(1, lookupTypeSingleSubstFormat2.doSubstitution(1, -1));
  }
  ...
  void testDoSubstitution_whenTwo_thenReturnTwo() {
    ...
    // Act and Assert
    assertEquals(2, lookupTypeSingleSubstFormat2.doSubstitution(2, 1));
  }
  ...
  void testDoSubstitution_whenZero_thenReturnOne() {
    ...
    // Act and Assert
    assertEquals(1, lookupTypeSingleSubstFormat2.doSubstitution(1, 0));
  }
}
