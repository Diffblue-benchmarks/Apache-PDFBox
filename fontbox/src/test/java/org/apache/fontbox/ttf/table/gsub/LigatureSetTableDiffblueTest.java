...
class LigatureSetTableDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void LigatureSetTable.<init>(int, LigatureTable[])",
    "int LigatureSetTable.getLigatureCount()",
    "LigatureTable[] LigatureSetTable.getLigatureTables()",
    "String LigatureSetTable.toString()"
  })
