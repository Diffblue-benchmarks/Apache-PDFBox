...
class LookupTypeAlternateSubstitutionFormat1DiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link LookupTypeAlternateSubstitutionFormat1#LookupTypeAlternateSubstitutionFormat1(int, CoverageTable, AlternateSetTable[])}
  ...
  @MethodsUnderTest({"void LookupTypeAlternateSubstitutionFormat1.<init>(int, CoverageTable, AlternateSetTable[])",
   ...
   * </ul>
   * <p>
   * Method under test: {@link LookupTypeAlternateSubstitutionFormat1#doSubstitution(int, int)}
   */
  @Test
