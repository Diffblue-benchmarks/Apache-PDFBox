...
class GlyphSubstitutionDataExtractorDiffblueTest {
  /**
   * Method under test:
   * {@link GlyphSubstitutionDataExtractor#getGsubData(String, ScriptTable, FeatureListTable, LookupListTable)}
   */
  @Test
  void testGetGsubData() {
    // Arrange
