...
class AlternateSetTableDiffblueTest {
  ...
  @MethodsUnderTest({"void AlternateSetTable.<init>(int, int[])", "int[] AlternateSetTable.getAlternateGlyphIDs()",
      "int AlternateSetTable.getGlyphCount()", "String AlternateSetTable.toString()"})
