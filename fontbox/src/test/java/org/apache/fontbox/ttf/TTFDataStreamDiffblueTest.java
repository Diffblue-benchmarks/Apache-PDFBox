...
class TTFDataStreamDiffblueTest {
  ...
  void testRead32Fixed_thenThrowEOFException() throws IOException {
    ...
    assertThrows(
        EOFException.class,
        () -> new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer()).read32Fixed());
  }
  ...
  void testReadStringWithLengthCharset_thenThrowIOException() throws IOException {
    // Arrange
    RandomAccessReadDataStream randomAccessReadDataStream =
        new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer());
  ...
  void testReadStringWithLength_thenThrowIOException() throws IOException {
    ...
    assertThrows(
        IOException.class,
        () -> new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer()).readString(3));
  }
  ...
  void testReadUnsignedByte_thenThrowEOFException() throws IOException {
    ...
    assertThrows(
        EOFException.class,
        () -> new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer()).readUnsignedByte());
  }
  ...
  void testReadUnsignedInt_thenThrowEOFException() throws IOException {
    ...
    assertThrows(
        EOFException.class,
        () -> new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer()).readUnsignedInt());
  }
  ...
  void testReadUnsignedShort_thenThrowEOFException() throws IOException {
    ...
    assertThrows(
        EOFException.class,
        () ->
            new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer()).readUnsignedShort());
  }
  ...
  void testReadSignedShort_thenThrowEOFException() throws IOException {
    ...
    assertThrows(
        EOFException.class,
        () -> new RandomAccessReadDataStream(new RandomAccessReadWriteBuffer()).readSignedShort());
  }
