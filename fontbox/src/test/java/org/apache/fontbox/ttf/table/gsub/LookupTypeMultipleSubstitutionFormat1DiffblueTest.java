...
class LookupTypeMultipleSubstitutionFormat1DiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link LookupTypeMultipleSubstitutionFormat1#LookupTypeMultipleSubstitutionFormat1(int, CoverageTable, SequenceTable[])}
  ...
  @MethodsUnderTest({"void LookupTypeMultipleSubstitutionFormat1.<init>(int, CoverageTable, SequenceTable[])",
   ...
   * </ul>
   * <p>
   * Method under test: {@link LookupTypeMultipleSubstitutionFormat1#doSubstitution(int, int)}
   */
  @Test
