...
class TilingPaintFactoryDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test create(PDTilingPattern, PDColorSpace, PDColor, AffineTransform); when RotateInstance is ten; then calls getScalingFactorX()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Paint TilingPaintFactory.create(PDTilingPattern, PDColorSpace, PDColor, AffineTransform)"
  })
  void testCreate_whenRotateInstanceIsTen_thenCallsGetScalingFactorX() throws IOException {
    // Arrange
    Matrix matrix = mock(Matrix.class);
    when(matrix.clone()).thenReturn(new Matrix());
    ...
    Paint actualCreateResult =
        tilingPaintFactory.create(
            ...
            AffineTransform.getRotateInstance(10.0d));
