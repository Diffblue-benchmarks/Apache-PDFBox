...
class CloseFillNonZeroAndStrokePathDiffblueTest {
  /**
   * Test {@link CloseFillNonZeroAndStrokePath#process(Operator, List)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link CloseFillNonZeroAndStrokePath#process(Operator, List)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CloseFillNonZeroAndStrokePath.process(Operator, List)"})
  void testProcess_givenPageDrawerProcessOperatorDoesNothing_thenCallsProcessOperator()
    ...
    CloseFillNonZeroAndStrokePath closeFillNonZeroAndStrokePath =
        new CloseFillNonZeroAndStrokePath(context);
