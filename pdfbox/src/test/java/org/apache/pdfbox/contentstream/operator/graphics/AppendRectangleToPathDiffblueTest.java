...
class AppendRectangleToPathDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link AppendRectangleToPath#process(Operator, List)}
   */
  @Test
  ...
  void testProcess_givenCOSFloatWithAFloatIs34028235e38() throws IOException {
    // Arrange
    AppendRectangleToPath appendRectangleToPath = new AppendRectangleToPath(null);
    ...
    // Act and Assert
    assertThrows(MissingOperandException.class, () -> appendRectangleToPath.process(operator, operands));
  }
  ...
  void testProcess_whenArrayList_thenThrowMissingOperandException() throws IOException {
    ...
    // Act and Assert
    assertThrows(MissingOperandException.class, () -> appendRectangleToPath.process(operator, new ArrayList<>()));
  }
}
