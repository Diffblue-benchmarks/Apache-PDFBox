...
class SetLineDashPatternDiffblueTest {
  ...
  void testProcess() throws IOException {
    ...
    COSStream cosStream =
        new COSStream(
            streamCache, new RandomAccessReadView(new RandomAccessReadWriteBuffer(), 2L, 3L));
   ...
   */
  @Test
  @DisplayName("Test process(Operator, List); given 'A'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SetLineDashPattern.process(Operator, List)"})
  void testProcess_givenA() throws IOException {
    // Arrange
    SetLineDashPattern setLineDashPattern = new SetLineDashPattern(new PDFMarkedContentExtractor());
    Operator operator = Operator.getOperator("Operator");
    ...
    COSStream cosStream =
        new COSStream(streamCache, new RandomAccessReadView(randomAccessRead, 2L, 3L));
    arguments.add(cosStream);
  ...
  void testProcess_givenFalse_whenArrayListAddFalse_thenDoesNotThrow()
    ...
    ArrayList<COSBase> arguments = new ArrayList<>();
    arguments.add(cosArray);
    arguments.add(COSBoolean.FALSE);

    // Act and Assert
    assertDoesNotThrow(() -> setLineDashPattern.process(operator, arguments));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SetLineDashPattern.process(Operator, List)"})
  void testProcess_givenFalse_whenArrayListAddFalse_thenDoesNotThrow2()
      throws MissingOperandException {
    // Arrange
    SetLineDashPattern setLineDashPattern = new SetLineDashPattern(new PDFMarkedContentExtractor());
    Operator operator = Operator.getOperator("Operator");
  ...
  @Test
  @DisplayName(
      "Test process(Operator, List); given RandomAccessReadWriteBuffer(int) with definedChunkSize is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SetLineDashPattern.process(Operator, List)"})
  void testProcess_givenRandomAccessReadWriteBufferWithDefinedChunkSizeIsThree()
      throws IOException {
    // Arrange
    SetLineDashPattern setLineDashPattern = new SetLineDashPattern(new PDFMarkedContentExtractor());
    Operator operator = Operator.getOperator("Operator");
    ...
    COSStream cosStream =
        new COSStream(
            streamCache, new RandomAccessReadView(new RandomAccessReadWriteBuffer(3), 2L, 3L));
    arguments.add(cosStream);
