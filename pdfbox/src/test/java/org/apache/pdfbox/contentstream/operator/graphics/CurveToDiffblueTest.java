...
class CurveToDiffblueTest {
  ...
  void testProcess_givenCOSFloatWithAFloatIs34028235e38() throws IOException {
    ...
    CurveTo curveTo = new CurveTo(context);
  ...
  void testProcess_givenFalse_whenArrayListAddFalse() throws IOException {
    ...
    // Act
    curveTo.process(operator, operands);
    ...
    verify(parameters).getRenderingHints();
    verify(parameters).isSubsamplingAllowed();
    assertTrue(curveTo.getGraphicsContext() instanceof PageDrawer);
  }
   ...
   *
   * <ul>
   *   <li>Then {@link CurveTo#CurveTo(PDFGraphicsStreamEngine)} with context is {@link
  ...
  @Test
  @DisplayName(
      "Test process(Operator, List); then CurveTo(PDFGraphicsStreamEngine) with context is PageDrawer(PageDrawerParameters) GraphicsContext CurrentPoint Float")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void CurveTo.process(Operator, List)"})
  void testProcess_thenCurveToWithContextIsPageDrawerGraphicsContextCurrentPointFloat()
      throws IOException {
    // Arrange
    PageDrawerParameters parameters = mock(PageDrawerParameters.class);
    when(parameters.isSubsamplingAllowed()).thenReturn(true);
    ...
    verify(parameters).getRenderingHints();
    verify(parameters).isSubsamplingAllowed();
    PDFGraphicsStreamEngine graphicsContext = curveTo.getGraphicsContext();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CurveTo.process(Operator, List)"})
  void testProcess_thenCurveToWithContextIsPageDrawerGraphicsContextCurrentPointFloat2()
      throws IOException {
    // Arrange
    PageDrawerParameters parameters = mock(PageDrawerParameters.class);
    when(parameters.isSubsamplingAllowed()).thenReturn(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CurveTo.process(Operator, List)"})
  void testProcess_thenCurveToWithContextIsPageDrawerGraphicsContextCurrentPointFloat3()
      throws IOException {
    // Arrange
    PageDrawerParameters parameters = mock(PageDrawerParameters.class);
    when(parameters.isSubsamplingAllowed()).thenReturn(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CurveTo.process(Operator, List)"})
  void testProcess_thenCurveToWithContextIsPageDrawerGraphicsContextCurrentPointFloat4()
      throws IOException {
    // Arrange
    PageDrawerParameters parameters = mock(PageDrawerParameters.class);
    when(parameters.isSubsamplingAllowed()).thenReturn(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CurveTo.process(Operator, List)"})
  void testProcess_thenCurveToWithContextIsPageDrawerGraphicsContextCurrentPointFloat5()
      throws IOException {
    // Arrange
    PageDrawerParameters parameters = mock(PageDrawerParameters.class);
    when(parameters.isSubsamplingAllowed()).thenReturn(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CurveTo.process(Operator, List)"})
  void testProcess_thenCurveToWithContextIsPageDrawerGraphicsContextCurrentPointFloat6()
      throws IOException {
    // Arrange
    PageDrawerParameters parameters = mock(PageDrawerParameters.class);
    when(parameters.isSubsamplingAllowed()).thenReturn(true);
