...
class ShowTextDiffblueTest {
  ...
  @MethodsUnderTest({"void ShowText.<init>(PDFStreamEngine)", "java.lang.String ShowText.getName()"})
   ...
   * Test {@link ShowText#process(Operator, List)}.
   * <ul>
   *   <li>Given {@link PDFStreamEngine} {@link PDFStreamEngine#showTextString(byte[])} does nothing.</li>
   * </ul>
   * <p>
   * Method under test: {@link ShowText#process(Operator, List)}
   */
