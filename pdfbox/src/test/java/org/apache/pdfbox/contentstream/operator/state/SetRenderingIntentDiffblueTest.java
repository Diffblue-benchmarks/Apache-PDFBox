...
class SetRenderingIntentDiffblueTest {
  ...
  @MethodsUnderTest({"void SetRenderingIntent.<init>(PDFStreamEngine)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link SetRenderingIntent#process(Operator, List)}
   */
  @Test
  ...
  void testProcess_whenArrayList_thenThrowMissingOperandException() throws IOException {
    ...
    // Act and Assert
    assertThrows(MissingOperandException.class, () -> setRenderingIntent.process(operator, new ArrayList<>()));
  }
}
