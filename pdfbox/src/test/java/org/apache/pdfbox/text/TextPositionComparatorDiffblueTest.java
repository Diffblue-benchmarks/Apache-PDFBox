...
class TextPositionComparatorDiffblueTest {
  /**
   * Test {@link TextPositionComparator#compare(TextPosition, TextPosition)} with {@code
   * TextPosition}, {@code TextPosition}.
   *
   * <p>Method under test: {@link TextPositionComparator#compare(TextPosition, TextPosition)}
   */
  @Test
  ...
  @Test
  @DisplayName(
      "Test compare(TextPosition, TextPosition) with 'TextPosition', 'TextPosition'; then return zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int TextPositionComparator.compare(TextPosition, TextPosition)"})
