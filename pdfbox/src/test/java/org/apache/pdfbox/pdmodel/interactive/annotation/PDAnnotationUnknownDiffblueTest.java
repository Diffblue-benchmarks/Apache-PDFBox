...
class PDAnnotationUnknownDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link PDAnnotationUnknown#PDAnnotationUnknown(COSDictionary)}
   */
  @Test
  @DisplayName("Test new PDAnnotationUnknown(COSDictionary); when COSDictionary(); then COSDictionary() size is one")
   ...
   */
  @Test
  @DisplayName("Test new PDAnnotationUnknown(COSDictionary); when COSStream(); then COSStream() size is two")
