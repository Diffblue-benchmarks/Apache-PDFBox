...
class PDPolylineAppearanceHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void PDPolylineAppearanceHandler.<init>(PDAnnotation)",
  ...
  void testGettersAndSetters_whenPDAnnotationCaret() {
    ...
    // Act
    PDPolylineAppearanceHandler actualPdPolylineAppearanceHandler =
        new PDPolylineAppearanceHandler(annotation);
   ...
   * </ul>
   *
   * <p>Method under test: {@link PDPolylineAppearanceHandler#getLineWidth()}
   */
  @Test
