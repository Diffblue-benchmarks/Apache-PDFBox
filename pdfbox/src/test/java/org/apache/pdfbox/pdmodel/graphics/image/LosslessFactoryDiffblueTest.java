...
class LosslessFactoryDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link LosslessFactory#createFromImage(PDDocument, BufferedImage)}
   */
  @Test
   ...
   * Test {@link LosslessFactory#createFromImage(PDDocument, BufferedImage)}.
   * <ul>
   *   <li>When {@link PDDocument#PDDocument(COSDocument)} with doc is {@link COSDocument#COSDocument()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link LosslessFactory#createFromImage(PDDocument, BufferedImage)}
   */
  ...
  /**
   * Test {@link LosslessFactory#prepareImageXObject(PDDocument, byte[], int, int, int, PDColorSpace)}.
   * <p>
   * Method under test: {@link LosslessFactory#prepareImageXObject(PDDocument, byte[], int, int, int, PDColorSpace)}
   */
  @Test
  ...
  void testPrepareImageXObject() throws IOException {
    ...
    // Assert
    assertTrue(
        actualPrepareImageXObjectResult.getOpaqueImage().getSampleModel() instanceof PixelInterleavedSampleModel);
    assertTrue(actualPrepareImageXObjectResult.getRawRaster().getSampleModel() instanceof PixelInterleavedSampleModel);
  }
