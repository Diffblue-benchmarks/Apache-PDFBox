...
class PDSquigglyAppearanceHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void PDSquigglyAppearanceHandler.<init>(PDAnnotation)",
  ...
  void testGettersAndSetters_whenPDAnnotationCaret() {
    ...
    // Act
    PDSquigglyAppearanceHandler actualPdSquigglyAppearanceHandler =
        new PDSquigglyAppearanceHandler(annotation);
