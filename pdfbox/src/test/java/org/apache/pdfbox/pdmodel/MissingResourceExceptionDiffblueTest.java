...
class MissingResourceExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link MissingResourceException#MissingResourceException(String)}
   */
  @Test
  ...
  void testNewMissingResourceException() {
    // Arrange and Act
    MissingResourceException actualMissingResourceException =
        new MissingResourceException("An error occurred");
