...
class RadialShadingContextDiffblueTest {
  /**
   * Test {@link RadialShadingContext#RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)}.
   * <p>
   * Method under test: {@link RadialShadingContext#RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)}
   */
  @Test
  @DisplayName("Test new RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void RadialShadingContext.<init>(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)"})
  void testNewRadialShadingContext() throws IOException {
    // Arrange
    ...
    // Act
    RadialShadingContext actualRadialShadingContext = new RadialShadingContext(shading, colorModel, xform, matrix,
        new Rectangle());
    ...
    assertArrayEquals(new float[]{0.95014954f, 1.0f, 1.0882568f}, ((ICC_ProfileRGB) profile).getMediaWhitePoint(),
        0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f}, actualRadialShadingContext.getDomain(), 0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f}, actualRadialShadingContext.getBackground(), 0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f, 10.0f, 0.5f, 10.0f, 0.5f},
        actualRadialShadingContext.getCoords(), 0.0f);
   ...
   */
  @Test
  @DisplayName("Test new RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle); given PDCalGray(); then return RgbBackground is zero")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void RadialShadingContext.<init>(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)"})
  void testNewRadialShadingContext_givenPDCalGray_thenReturnRgbBackgroundIsZero() throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[]{10.0f, 0.5f, 10.0f, 0.5f});
    COSArray cosArray2 = mock(COSArray.class);
    ...
    verify(shading, atLeast(1)).getDomain();
    verify(shading).getExtend();
    assertEquals(0, actualRadialShadingContext.getRgbBackground());
    assertSame(pdCalGray, actualRadialShadingContext.getShadingColorSpace());
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f}, actualRadialShadingContext.getDomain(), 0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f}, actualRadialShadingContext.getBackground(), 0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f, 10.0f, 0.5f, 10.0f, 0.5f},
        actualRadialShadingContext.getCoords(), 0.0f);
    assertArrayEquals(new int[]{8, 8, 8, 8}, actualRadialShadingContext.getColorModel().getComponentSize());
    assertArrayEquals(new boolean[]{false, false}, actualRadialShadingContext.getExtend());
  }
   ...
   */
  @Test
  @DisplayName("Test new RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle); given PDCalRGB(); then return RgbBackground is '64000'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void RadialShadingContext.<init>(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)"})
  void testNewRadialShadingContext_givenPDCalRGB_thenReturnRgbBackgroundIs64000() throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[]{10.0f, 0.5f, 10.0f, 0.5f});
    COSArray cosArray2 = mock(COSArray.class);
    ...
    verify(shading, atLeast(1)).getDomain();
    verify(shading).getExtend();
    assertEquals(64000, actualRadialShadingContext.getRgbBackground());
   ...
   */
  @Test
  @DisplayName("Test new RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle); then ColorModel ColorSpace return ICC_ColorSpace")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void RadialShadingContext.<init>(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)"})
  void testNewRadialShadingContext_thenColorModelColorSpaceReturnICC_ColorSpace() throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[]{10.0f, 0.5f, 10.0f, 0.5f});
    COSArray cosArray2 = mock(COSArray.class);
   ...
   */
  @Test
  @DisplayName("Test new RadialShadingContext(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle); then return Domain is array of float with '0.5' and '0.5'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "void RadialShadingContext.<init>(PDShadingType3, ColorModel, AffineTransform, Matrix, Rectangle)"})
  void testNewRadialShadingContext_thenReturnDomainIsArrayOfFloatWith05And05() throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[]{10.0f, 0.5f, 10.0f, 0.5f});
    COSArray cosArray2 = mock(COSArray.class);
    ...
    assertArrayEquals(new float[]{0.95014954f, 1.0f, 1.0882568f}, ((ICC_ProfileRGB) profile).getMediaWhitePoint(),
        0.0f);
    assertArrayEquals(new float[]{0.5f, 0.5f, 10.0f, 0.5f}, actualRadialShadingContext.getDomain(), 0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f}, actualRadialShadingContext.getBackground(), 0.0f);
    assertArrayEquals(new float[]{10.0f, 0.5f, 10.0f, 0.5f, 10.0f, 0.5f, 10.0f, 0.5f},
        actualRadialShadingContext.getCoords(), 0.0f);
    assertArrayEquals(new int[]{8, 8, 8, 8}, colorModel2.getComponentSize());
