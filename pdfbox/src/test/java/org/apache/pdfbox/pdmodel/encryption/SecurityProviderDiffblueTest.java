...
class SecurityProviderDiffblueTest {
   ...
   *
   * <p>Method under test: {@link SecurityProvider#getProvider()}
   */
  @Test
  ...
  void testGetProvider() {
    ...
    assertEquals(
        "PBKDF1", actualProvider.get("Alg.Alias.AlgorithmParameters.1.2.840.113549.1.5.10"));
    assertEquals(
        "PBKDF1", actualProvider.get("Alg.Alias.AlgorithmParameters.1.2.840.113549.1.5.11"));
    assertEquals(
        "PBKDF2", actualProvider.get("Alg.Alias.AlgorithmParameters.1.2.840.113549.1.5.12"));
