...
class RC4CipherDiffblueTest {
  ...
  /**
   * Test {@link RC4Cipher#write(byte[], int, int, OutputStream)} with {@code byte[]}, {@code int}, {@code int}, {@code OutputStream}.
   * <p>
  ...
  /**
   * Test {@link RC4Cipher#write(InputStream, OutputStream)} with {@code InputStream}, {@code OutputStream}.
   * <p>
