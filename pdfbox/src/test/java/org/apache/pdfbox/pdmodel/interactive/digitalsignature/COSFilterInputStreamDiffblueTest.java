...
class COSFilterInputStreamDiffblueTest {
  /**
   * Test {@link COSFilterInputStream#read(byte[], int, int)} with {@code b}, {@code off}, {@code len}.
   * <ul>
   *   <li>Given {@link DataInputStream} {@link FilterInputStream#skip(long)} return one.</li>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"byte[] COSFilterInputStream.toByteArray()"})
