...
class PDLineAppearanceHandlerDiffblueTest {
  ...
  @MethodsUnderTest({"void PDLineAppearanceHandler.<init>(PDAnnotation)",
  ...
  void testGenerateNormalAppearance3() {
    ...
    assertArrayEquals(new float[]{90.0f, 100.0f, 1.0f}, values[2], 0.0f);
  }
   ...
   * Test {@link PDLineAppearanceHandler#generateNormalAppearance()}.
   * <ul>
   *   <li>Given {@link COSArray#COSArray(List)} with cosObjectables is {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PDLineAppearanceHandler#generateNormalAppearance()}
   */
  @Test
  @DisplayName("Test generateNormalAppearance(); given COSArray(List) with cosObjectables is ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PDLineAppearanceHandler.generateNormalAppearance()"})
  void testGenerateNormalAppearance_givenCOSArrayWithCosObjectablesIsArrayList() {
    // Arrange
    PDBorderStyleDictionary pdBorderStyleDictionary = mock(PDBorderStyleDictionary.class);
    when(pdBorderStyleDictionary.getDashStyle()).thenReturn(new PDLineDashPattern());
    when(pdBorderStyleDictionary.getWidth()).thenReturn(10.0f);
    ...
    when(annotation.getCaptionHorizontalOffset()).thenReturn(10.0f);
    when(annotation.getCaptionVerticalOffset()).thenReturn(10.0f);
    when(annotation.getInteriorColor()).thenReturn(new PDColor(new COSArray(new ArrayList<>()), PDDeviceGray.INSTANCE));
    when(annotation.getCaptionPositioning()).thenReturn("Caption Positioning");
    when(annotation.getEndPointEndingStyle()).thenReturn("https://config.us-east-2.amazonaws.com");
    when(annotation.hasCaption()).thenReturn(true);
    when(annotation.getConstantOpacity()).thenReturn(10.0f);
   ...
   * Test {@link PDLineAppearanceHandler#generateNormalAppearance()}.
   * <ul>
   *   <li>Given {@link PDAnnotationLine} {@link PDAnnotation#getColor()} return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PDLineAppearanceHandler#generateNormalAppearance()}
   */
   ...
   * Test {@link PDLineAppearanceHandler#generateNormalAppearance()}.
   * <ul>
   *   <li>Given {@link PDAnnotationLine} {@link PDAnnotation#getContents()} return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PDLineAppearanceHandler#generateNormalAppearance()}
   */
   ...
   * Test {@link PDLineAppearanceHandler#generateNormalAppearance()}.
   * <ul>
   *   <li>Given {@link PDAnnotationLine} {@link PDAnnotationLine#getInteriorColor()} return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PDLineAppearanceHandler#generateNormalAppearance()}
   */
   ...
   * Test {@link PDLineAppearanceHandler#generateNormalAppearance()}.
   * <ul>
   *   <li>Given {@link PDAnnotationLine} {@link PDAnnotationLine#getLine()} return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PDLineAppearanceHandler#generateNormalAppearance()}
   */
   ...
   * Test {@link PDLineAppearanceHandler#generateNormalAppearance()}.
   * <ul>
   *   <li>Given {@link PDAnnotationLine} {@link PDAnnotationLine#hasCaption()} return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PDLineAppearanceHandler#generateNormalAppearance()}
   */
