...
class PDLineAppearanceHandlerDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test generateNormalAppearance(); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PDLineAppearanceHandler.generateNormalAppearance()"})
  void testGenerateNormalAppearance_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(
        () -> new PDLineAppearanceHandler(new PDAnnotationLine()).generateNormalAppearance());
  }
}
