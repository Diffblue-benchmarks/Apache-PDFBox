...
class Type1ShadingContextDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test new Type1ShadingContext(PDShadingType1, ColorModel, AffineTransform, Matrix); given COSArray(List) with cosObjectables is ArrayList() add FALSE")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void Type1ShadingContext.<init>(PDShadingType1, ColorModel, AffineTransform, Matrix)"
  })
  void testNewType1ShadingContext_givenCOSArrayWithCosObjectablesIsArrayListAddFalse()
      throws IOException {
    // Arrange
    COSArray cosArray = new COSArray(new ArrayList<>());
    ...
    assertArrayEquals(
        new float[] {0.0f}, shadingColorSpace.getInitialColor().getComponents(), 0.0f);
    assertArrayEquals(new float[] {0.0f, 1.0f}, actualType1ShadingContext.getDomain(), 0.0f);
    assertArrayEquals(new float[] {0.013916016f, 0.09713745f, 0.71383667f}, matrix[2], 0.0f);
    assertArrayEquals(new float[] {0.22238159f, 0.717041f, 0.06059265f}, matrix[1], 0.0f);
    assertArrayEquals(new float[] {0.43585205f, 0.3853302f, 0.14302063f}, matrix[0], 0.0f);
    assertArrayEquals(
   ...
   *   <li>When {@link PDShadingType1} {@link PDShadingType1#getMatrix()} return {@link
   *       Matrix#Matrix()}.
   * </ul>
   *
   * <p>Method under test: {@link Type1ShadingContext#Type1ShadingContext(PDShadingType1,
  ...
  @Test
  @DisplayName(
      "Test new Type1ShadingContext(PDShadingType1, ColorModel, AffineTransform, Matrix); given Matrix(); when PDShadingType1 getMatrix() return Matrix()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void Type1ShadingContext.<init>(PDShadingType1, ColorModel, AffineTransform, Matrix)"
  })
  void testNewType1ShadingContext_givenMatrix_whenPDShadingType1GetMatrixReturnMatrix()
      throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[] {10.0f, 0.5f, 10.0f, 0.5f});
   ...
   *
   * <ul>
   *   <li>Then return Domain is array of {@code float} with zero.
   * </ul>
   *
   * <p>Method under test: {@link Type1ShadingContext#Type1ShadingContext(PDShadingType1,
   * ColorModel, AffineTransform, Matrix)}
  ...
  @Test
  @DisplayName(
      "Test new Type1ShadingContext(PDShadingType1, ColorModel, AffineTransform, Matrix); then return Domain is array of float with zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void Type1ShadingContext.<init>(PDShadingType1, ColorModel, AffineTransform, Matrix)"
  })
  void testNewType1ShadingContext_thenReturnDomainIsArrayOfFloatWithZero() throws IOException {
    // Arrange
    COSArray cosArray = new COSArray(new ArrayList<>());
    ...
    assertArrayEquals(
        new float[] {0.0f}, shadingColorSpace.getInitialColor().getComponents(), 0.0f);
    assertArrayEquals(new float[] {0.0f}, actualType1ShadingContext.getDomain(), 0.0f);
    assertArrayEquals(new float[] {0.013916016f, 0.09713745f, 0.71383667f}, matrix[2], 0.0f);
    assertArrayEquals(new float[] {0.22238159f, 0.717041f, 0.06059265f}, matrix[1], 0.0f);
    assertArrayEquals(new float[] {0.43585205f, 0.3853302f, 0.14302063f}, matrix[0], 0.0f);
    assertArrayEquals(
  ...
  @Test
  @DisplayName(
      "Test new Type1ShadingContext(PDShadingType1, ColorModel, AffineTransform, Matrix); then return Domain is array of float with zero and one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void Type1ShadingContext.<init>(PDShadingType1, ColorModel, AffineTransform, Matrix)"
  })
  void testNewType1ShadingContext_thenReturnDomainIsArrayOfFloatWithZeroAndOne()
      throws IOException {
    // Arrange
    PDShadingType1 shading = mock(PDShadingType1.class);
    when(shading.getBackground()).thenReturn(null);
    ...
    assertArrayEquals(
        ...
        0.0f);
    assertArrayEquals(
        new float[] {0.0f, 1.0f, 0.0f, 1.0f}, actualType1ShadingContext.getDomain(), 0.0f);
    assertArrayEquals(new int[] {8, 8, 8, 8}, colorModel2.getComponentSize());
  }
  ...
  @Test
  @DisplayName(
      "Test new Type1ShadingContext(PDShadingType1, ColorModel, AffineTransform, Matrix); then ShadingColorSpace return PDDeviceGray")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void Type1ShadingContext.<init>(PDShadingType1, ColorModel, AffineTransform, Matrix)"
  })
  void testNewType1ShadingContext_thenShadingColorSpaceReturnPDDeviceGray() throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[] {10.0f, 0.5f, 10.0f, 0.5f});
    doNothing().when(cosArray).add(Mockito.<COSBase>any());
  ...
  void testNewType1ShadingContext_thenShadingColorSpaceReturnPDDeviceGray2() throws IOException {
    // Arrange
    COSArray cosArray = mock(COSArray.class);
    when(cosArray.toFloatArray()).thenReturn(new float[] {10.0f, 0.5f, 10.0f, 0.5f});
    doNothing().when(cosArray).add(Mockito.<COSBase>any());
