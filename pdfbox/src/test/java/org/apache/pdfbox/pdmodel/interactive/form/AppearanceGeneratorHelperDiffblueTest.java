...
class AppearanceGeneratorHelperDiffblueTest {
   ...
   * {@link PDAnnotationWidget#PDAnnotationWidget()}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link AppearanceGeneratorHelper#AppearanceGeneratorHelper(PDVariableText)}
  ...
  void testSetAppearanceValue() throws IOException {
    ...
    when(fontDictionary.getInt(Mockito.<COSName>any(), anyInt())).thenThrow(new IllegalArgumentException("g9"));
   ...
   * Test {@link AppearanceGeneratorHelper#setAppearanceValue(String)}.
   * <ul>
   *   <li>Given {@link PDResources#PDResources(COSDictionary)} with
   ...
   */
  @Test
  @DisplayName("Test setAppearanceValue(String); given PDResources(COSDictionary) with resourceDictionary is COSDictionary()")
  void testSetAppearanceValue_givenPDResourcesWithResourceDictionaryIsCOSDictionary() throws IOException {
    // Arrange
    ArrayList<PDAnnotationWidget> pdAnnotationWidgetList = new ArrayList<>();
    pdAnnotationWidgetList.add(new PDAnnotationWidget());
    PDVariableText field = mock(PDVariableText.class);
    ...
    COSString defaultAppearance = COSString.parseHex("0123456789ABCDEF");
    when(field.getDefaultAppearanceString())
        .thenReturn(new PDDefaultAppearanceString(defaultAppearance, new PDResources(new COSDictionary())));
    when(field.getWidgets()).thenReturn(pdAnnotationWidgetList);
    when(field.getActions()).thenReturn(new PDFormFieldAdditionalActions());
    when(field.getAcroForm()).thenReturn(new PDAcroForm(new PDDocument()));
   ...
   * Test {@link AppearanceGeneratorHelper#setAppearanceValue(String)}.
   * <ul>
   *   <li>Given {@link PDVariableText} {@link PDVariableText#getQ()} return
   * five.</li>
  ...
  @Test
  @DisplayName("Test setAppearanceValue(String); then throw IllegalArgumentException")
  void testSetAppearanceValue_thenThrowIllegalArgumentException3() throws IOException {
    // Arrange
    COSString defaultAppearance = COSString.parseHex("0123456789ABCDEF");
