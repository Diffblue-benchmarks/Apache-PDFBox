...
class Type5ShadingPaintDiffblueTest {
  /**
   * Method under test:
   * {@link Type5ShadingPaint#createContext(ColorModel, Rectangle, Rectangle2D, AffineTransform, RenderingHints)}
   */
  @Test
  void testCreateContext() {
    ...
    PDShadingType5 shading = new PDShadingType5(shadingDictionary);
