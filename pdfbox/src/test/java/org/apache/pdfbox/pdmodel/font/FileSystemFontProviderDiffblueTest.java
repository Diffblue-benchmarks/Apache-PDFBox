...
class FileSystemFontProviderDiffblueTest {
   ...
   *
   * <p>Method under test: {@link FileSystemFontProvider#FileSystemFontProvider(FontCache)}
   */
  @Test
  ...
  void testNewFileSystemFontProvider() {
    // Arrange and Act
    FileSystemFontProvider actualFileSystemFontProvider =
        new FileSystemFontProvider(new FontCache());
   ...
   *
   * <p>Method under test: {@link FileSystemFontProvider#toDebugString()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link FileSystemFontProvider#getFontInfo()}
   */
  @Test
  ...
  void testGetFontInfo() {
    // Arrange and Act
    List<? extends FontInfo> actualFontInfo =
        new FileSystemFontProvider(new FontCache()).getFontInfo();
