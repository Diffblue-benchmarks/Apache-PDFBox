...
class PDUnderlineAppearanceHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void PDUnderlineAppearanceHandler.<init>(PDAnnotation)",
  ...
  void testGettersAndSetters_whenPDAnnotationCaret() {
    ...
    // Act
    PDUnderlineAppearanceHandler actualPdUnderlineAppearanceHandler =
        new PDUnderlineAppearanceHandler(annotation);
