...
class JPXFilterDiffblueTest {
  ...
  /**
   * Test {@link JPXFilter#decode(InputStream, OutputStream, COSDictionary, int)}
   * with {@code encoded}, {@code decoded}, {@code parameters}, {@code index}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test decode(InputStream, OutputStream, COSDictionary, int) with 'encoded', 'decoded', 'parameters', 'index'; given COSDictionary()")
  ...
  /**
   * Test {@link JPXFilter#encode(InputStream, OutputStream, COSDictionary)} with
