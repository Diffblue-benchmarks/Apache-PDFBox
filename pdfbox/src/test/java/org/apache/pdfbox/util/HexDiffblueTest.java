...
class HexDiffblueTest {
   ...
   *
   * <p>Method under test: {@link Hex#getString(byte)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link Hex#getBytes(byte)}
   */
  @Test
  ...
  void testGetBytesWithBytes() throws UnsupportedEncodingException {
    // Arrange, Act and Assert
    assertArrayEquals(
        "4158415841584158".getBytes("UTF-8"), Hex.getBytes("AXAXAXAX".getBytes("UTF-8")));
  }

  /**
   * Test {@link Hex#getChars(short)}.
   *
   * <p>Method under test: {@link Hex#getChars(short)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link Hex#getCharsUTF16BE(String)}
   */
  @Test
  ...
  void testGetCharsUTF16BE() {
    ...
    // Assert
    assertArrayEquals(
        "0030003100320033003400350036003700380039004100420043004400450046".toCharArray(),
        actualCharsUTF16BE);
  }
   ...
   *       byte} with {@code 4} and {@code 1}.
   * </ul>
   *
   * <p>Method under test: {@link Hex#writeHexByte(byte, OutputStream)}
   */
  @Test
  @DisplayName(
      "Test writeHexByte(byte, OutputStream); then ByteArrayOutputStream() toByteArray is array of byte with '4' and '1'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Hex.writeHexByte(byte, OutputStream)"})
  void testWriteHexByte_thenByteArrayOutputStreamToByteArrayIsArrayOfByteWith4And1()
      throws IOException {
    // Arrange
   ...
   *
   * <p>Method under test: {@link Hex#writeHexBytes(byte[], OutputStream)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Then return array of {@code byte} with minus forty-five and {@code ]}.
   * </ul>
   *
   * <p>Method under test: {@link Hex#decodeBase64(String)}
   */
  @Test
  ...
  void testDecodeBase64_thenReturnArrayOfByteWithMinusFortyFiveAndRightSquareBracket() {
    // Arrange, Act and Assert
    assertArrayEquals(
        new byte[] {-45, ']', -73, -29, -98, -69, -13, -48, 1, '\b', '1', 5},
   ...
   * </ul>
   *
   * <p>Method under test: {@link Hex#decodeHex(String)}
   */
  @Test
  @DisplayName(
      "Test decodeHex(String); when '0123456789ABCDEF'; then return array of byte with one and '#'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testDecodeHex_when0123456789abcdef_thenReturnArrayOfByteWithOneAndNumberSign() {
    // Arrange, Act and Assert
    assertArrayEquals(
        new byte[] {1, '#', 'E', 'g', -119, -85, -51, -17}, Hex.decodeHex("0123456789ABCDEF"));
  }
