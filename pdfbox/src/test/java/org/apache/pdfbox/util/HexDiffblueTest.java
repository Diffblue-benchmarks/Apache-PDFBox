...
class HexDiffblueTest {
   ...
   * <ul>
   *   <li>Then return array of {@code byte} with minus forty-five and
   * {@code ]}.</li>
   * </ul>
   * <p>
   ...
   */
  @Test
  @DisplayName("Test decodeHex(String); when 'foo'; then return array length is zero")
  void testDecodeHex_whenFoo_thenReturnArrayLengthIsZero() {
    // Arrange, Act and Assert
    assertEquals(0, Hex.decodeHex("foo").length);
  }
}
