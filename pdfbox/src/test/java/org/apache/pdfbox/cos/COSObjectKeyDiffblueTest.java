...
class COSObjectKeyDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test new COSObjectKey(long, int, int); when minus one; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new COSObjectKey(long, int, int); when zero; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void COSObjectKey.<init>(long, int, int)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long COSObjectKey.getInternalHash()", "int COSObjectKey.getStreamIndex()",
