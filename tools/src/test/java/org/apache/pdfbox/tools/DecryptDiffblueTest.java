...
class DecryptDiffblueTest {
  @InjectMocks private Decrypt decrypt;

  @Mock private File file;

  /**
   * Test {@link Decrypt#call()}.
   *
   * <p>Method under test: {@link Decrypt#call()}
   */
  @Test
  @DisplayName("Test call()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Integer Decrypt.call()"})
  void testCall() {
    // Arrange
    when(file.toPath()).thenReturn(Paths.get(System.getProperty("java.io.tmpdir"), ""));

    // Act
    Integer actualCallResult = decrypt.call();
