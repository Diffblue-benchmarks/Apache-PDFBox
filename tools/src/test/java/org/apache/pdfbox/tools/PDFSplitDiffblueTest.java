...
class PDFSplitDiffblueTest {
  @Mock private File file;

  @InjectMocks private PDFSplit pDFSplit;

  /**
   * Test {@link PDFSplit#call()}.
   *
   * <p>Method under test: {@link PDFSplit#call()}
   */
  @Test
  @DisplayName("Test call()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Integer PDFSplit.call()"})
  void testCall() {
    // Arrange
    ...
    // Act
    Integer actualCallResult = pDFSplit.call();
