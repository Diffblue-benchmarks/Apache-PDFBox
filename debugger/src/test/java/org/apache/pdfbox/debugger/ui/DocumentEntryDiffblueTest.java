...
class DocumentEntryDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DocumentEntry.<init>(PDDocument, String)",
    "String DocumentEntry.toString()"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link DocumentEntry#getPageCount()}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link DocumentEntry#getPage(int)}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link DocumentEntry#indexOf(PageEntry)}
   */
  @Test
  ...
  void testIndexOf_thenReturnNine() {
    ...
    int actualIndexOfResult =
        documentEntry.indexOf(new PageEntry(new COSDictionary(), 10, "Page Label"));
