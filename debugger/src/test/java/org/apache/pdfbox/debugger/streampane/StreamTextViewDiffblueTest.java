...
class StreamTextViewDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code 42}.
   *   <li>When {@link DefaultStyledDocument#DefaultStyledDocument()} Property {@code Key} is {@code
   *       42}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test new StreamTextView(StyledDocument, ToolTipController); given '42'; when DefaultStyledDocument() Property 'Key' is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void StreamTextView.<init>(StyledDocument, ToolTipController)"})
  void testNewStreamTextView_given42_whenDefaultStyledDocumentPropertyKeyIs42() {
    // Arrange
    DefaultStyledDocument document = new DefaultStyledDocument();
    document.putProperty("Key", "42");
   ...
   * <ul>
   *   <li>Given {@code 42}.
   *   <li>When {@link ToolTipController#ToolTipController(PDResources)} with resources is {@code
   *       null}.
   * </ul>
   *
   * <p>Method under test: {@link StreamTextView#StreamTextView(StyledDocument, ToolTipController)}
  ...
  @Test
  @DisplayName(
      "Test new StreamTextView(StyledDocument, ToolTipController); given '42'; when ToolTipController(PDResources) with resources is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void StreamTextView.<init>(StyledDocument, ToolTipController)"})
  void testNewStreamTextView_given42_whenToolTipControllerWithResourcesIsNull() {
    // Arrange
    DefaultStyledDocument document = new DefaultStyledDocument();
    document.putProperty("Key", "42");

    // Act
    StreamTextView actualStreamTextView = new StreamTextView(document, new ToolTipController(null));
   ...
   * <ul>
   *   <li>Given one.
   *   <li>When {@link DefaultStyledDocument#DefaultStyledDocument()} Property {@code Key} is one.
   * </ul>
   *
   * <p>Method under test: {@link StreamTextView#StreamTextView(StyledDocument, ToolTipController)}
   */
  @Test
  @DisplayName(
      "Test new StreamTextView(StyledDocument, ToolTipController); given one; when DefaultStyledDocument() Property 'Key' is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void StreamTextView.<init>(StyledDocument, ToolTipController)"})
  void testNewStreamTextView_givenOne_whenDefaultStyledDocumentPropertyKeyIsOne() {
    // Arrange
    DefaultStyledDocument document = new DefaultStyledDocument();
    document.putProperty("Key", 1);
