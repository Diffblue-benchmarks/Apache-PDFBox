...
class AnnotFlagDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AnnotFlag.<init>(COSDictionary)",
    "java.lang.String AnnotFlag.getFlagType()"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link AnnotFlag#getFlagValue()}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link AnnotFlag#getFlagBits()}
   */
  @Test
