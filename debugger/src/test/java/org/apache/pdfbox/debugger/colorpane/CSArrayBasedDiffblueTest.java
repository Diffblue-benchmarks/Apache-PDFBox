...
class CSArrayBasedDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return first element Text is {@code Colorspace array is empty}.
   * </ul>
   *
   * <p>Method under test: {@link CSArrayBased#CSArrayBased(COSArray)}
   */
  @Test
  @DisplayName(
      "Test new CSArrayBased(COSArray); then return first element Text is 'Colorspace array is empty'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void CSArrayBased.<init>(COSArray)"})
