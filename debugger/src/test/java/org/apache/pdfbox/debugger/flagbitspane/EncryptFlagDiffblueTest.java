...
class EncryptFlagDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void EncryptFlag.<init>(COSDictionary)",
    "java.lang.String EncryptFlag.getFlagType()"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link EncryptFlag#getFlagValue()}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link EncryptFlag#getFlagBits()}
   */
  @Test
