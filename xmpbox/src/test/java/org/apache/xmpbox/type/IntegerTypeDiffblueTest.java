...
class IntegerTypeDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test setValue(Object); when '42'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void IntegerType.setValue(Object)"})
  void testSetValue_when42_thenDoesNotThrow() {
    // Arrange
    IntegerType integerType =
        new IntegerType(
            XMPMetadata.createXMPMetadata(), "Namespace URI", "Prefix", "Property Name", 42);
    ...
    // Act and Assert
    assertDoesNotThrow(() -> integerType.setValue("42"));
  }
   ...
   */
  @Test
  @DisplayName("Test setValue(Object); when forty-two; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void IntegerType.setValue(Object)"})
  void testSetValue_whenFortyTwo_thenDoesNotThrow() {
    // Arrange
    IntegerType integerType =
        new IntegerType(
            XMPMetadata.createXMPMetadata(), "Namespace URI", "Prefix", "Property Name", 42);
