...
class XmpSerializerDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test serializeFields(Document, Element, List, String, String, boolean); when ArrayList(); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void XmpSerializer.serializeFields(Document, Element, List, String, String, boolean)"
  })
  void testSerializeFields_whenArrayList_thenDoesNotThrow() {
    // Arrange
    XmpSerializer xmpSerializer = new XmpSerializer();
    IIOMetadataNode parent = new IIOMetadataNode();
    ...
    assertDoesNotThrow(
        () ->
            xmpSerializer.serializeFields(
                null, parent, new ArrayList<>(), "Resource NS", "Prefix", true));
  }
}
